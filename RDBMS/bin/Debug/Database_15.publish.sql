...
GO
PRINT N'Creating [dbo].[dim_ProductInfo]...';


GO
CREATE TABLE [dbo].[dim_ProductInfo] (
    [srky_ProductInfo] INT             IDENTITY (1, 1) NOT NULL,
    ...
    PRIMARY KEY CLUSTERED ([srky_ProductInfo] ASC)
);
...
GO
PRINT N'Creating unnamed constraint on [dbo].[fact_Quotes]...';
